...
module.exports = {
    ...
    cleanPublishTestByPost: function (pool, ptl_test_id) {
        return new Promise(function (resolve, reject) {
            var query = `DELETE FROM tm_publish_test_by_post WHERE published_test_id IN (?)`;
    ...
    addPublishTestByPost: function (pool, data) {
        return new Promise(function (resolve, reject) {
            var insert_array = [];
            var query = `INSERT INTO tm_publish_test_by_post
                              (post_id, 
                              post_name, 
                              published_test_id) 
                            VALUES ?`;
            ...
            data.forEach(function (value) {
                insert_array.push([value.post_id, value.post_name, value.published_test_id]);
            });
